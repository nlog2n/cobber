    ...
    partial class AntiTamperObfuscation
    {
        class Mem : IAntiTamper
        {
            ...
            public void InitPhase1(ModuleDefinition mod)
            {
                ...
                cobber.Database.AddEntry("AntiTamper", "Key5", key5);
                cobber.Database.AddEntry("AntiTamper", "Key6", key6);
            ...
            public void Phase1(ModuleDefinition mod)
            {
                ...
                cobber.Database.AddEntry("AntiTamper", "Helper", root.FullName);
            }
            ...
            public void Phase5(Stream stream, MetadataProcessor.ImageAccessor accessor)
            {
                ...
                for (int i = 0; i < codes.Length; i++)
                {
                    ...
                    cobber.Database.AddEntry("AntiTamper", rvas[i].ToString("X8"), ms.Position);
