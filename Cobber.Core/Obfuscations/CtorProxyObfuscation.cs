...
{
    public class CtorProxyObfuscation : IObfuscation
    {
        class Phase1 : StructurePhase, IProgressProvider
        {
            CtorProxyObfuscation cc;
            public Phase1(CtorProxyObfuscation cc) { this.cc = cc; }
            ...
            {
                return Namer.GetNewName(mbr.ToString());
            }
        ...
        {
            CtorProxyObfuscation cc;
            public Phase2(CtorProxyObfuscation cc) { this.cc = cc; }
            public override IObfuscation Obfuscator
            {
                get { return cc; }
            }
        ...
        {
            CtorProxyObfuscation cc;
            public MdPhase1(CtorProxyObfuscation cc) { this.cc = cc; }
            public override IObfuscation Obfuscator
            {
                get { return cc; }
            }
        ...
        {
            CtorProxyObfuscation cc;
            public MdPhase2(CtorProxyObfuscation cc) { this.cc = cc; }
            public override IObfuscation Obfuscator
            {
                get { return cc; }
            }
        ...
        public string ID { get { return "ctor proxy"; } }
        public string Name { get { return "Constructor Proxy"; } }
        public string Description { get { return "create proxies between references of constructors and methods code."; } }
