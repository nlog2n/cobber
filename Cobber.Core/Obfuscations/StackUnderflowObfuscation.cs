...
{
    public class StackUnderflowObfuscation : StructurePhase, IObfuscation
    {
        public string ID
        {
        ...
        {
            get { return "add a piece of code in the front of the methods and cause decompilers to crash."; }
        }
        ...
        {
            MethodDefinition mtd = target as MethodDefinition;
