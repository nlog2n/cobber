...
{
    public class MethodProxyObfuscation : IObfuscation
    {
        class Phase1 : StructurePhase, IProgressProvider
        {
            MethodProxyObfuscation mc;
            public Phase1(MethodProxyObfuscation mc) { this.mc = mc; }
            public override IObfuscation Obfuscator { get { return mc; } }
            ...
            public override void DeInitialize()
            {
                ...
                txt.proxy.Name = Namer.GetRandomName();
                AddHelper(modType, txt.proxy, 0);
            ...
            public override void Process(object target, NameValueCollection parameters)
            {
                ...
                if (Array.IndexOf(parameters.AllKeys, "onlyExternal") != -1)
                {
                    if (!bool.TryParse(parameters["onlyExternal"], out onlyExternal))
                    {
                ...
                IList<Tuple<IAnnotationProvider, NameValueCollection>> targets = target as IList<Tuple<IAnnotationProvider, NameValueCollection>>;
            ...
            {
                return Namer.GetNewName((isVirt ? "V>." : "") + mbr.ToString());
            }
            string GetNameO(ParameterDefinition arg)
            {
                return Namer.GetNewName(arg.Name);
            }
            string GetSignatureO(MethodReference mbr)
            {
                return Namer.GetNewName(GetSignature(mbr));
            }
        ...
        {
            MethodProxyObfuscation mc;
            public Phase2(MethodProxyObfuscation mc) { this.mc = mc; }
            public override IObfuscation Obfuscator { get { return mc; } }
        ...
        {
            MethodProxyObfuscation mc;
            public MdPhase1(MethodProxyObfuscation mc) { this.mc = mc; }
            public override IObfuscation Obfuscator
            {
                get { return mc; }
            }
        ...
        {
            MethodProxyObfuscation mc;
            public MdPhase2(MethodProxyObfuscation mc) { this.mc = mc; }
            public override IObfuscation Obfuscator
            {
                get { return mc; }
            }
        ...
        public string ID { get { return "mtd proxy"; } }
        public string Name { get { return "Method Proxy"; } }
        public string Description { get { return "create proxies between references of methods and methods code."; } }
        ...
        public Dictionary<string, List<string>> Parameters
        {
            get
            {
                ...
                {
                    {"type", new List<string> {"normal","native"}},
                    {"onlyExternal", new List<string> {"true","false"}}
                };
            }
        }
