...
{
    public class InvalidMetadataObfuscation : IObfuscation
    {
        class Phase1 : MetadataPhase
        {
            InvalidMetadataObfuscation cion;
            public Phase1(InvalidMetadataObfuscation cion) { this.cion = cion; }
        ...
        {
            InvalidMetadataObfuscation cion;
            public Phase2(InvalidMetadataObfuscation cion) { this.cion = cion; }
            public override Priority Priority
            {
                get { return Priority.MetadataLevel; }
            }
            ...
            public override void Process(NameValueCollection parameters, MetadataProcessor.MetadataAccessor accessor)
            {
                ...
                accessor.TableHeap.GetTable<ModuleTable>(Table.Module).AddRow(accessor.StringHeap.GetStringIndex(Namer.GetRandomName()));
                ...
                accessor.TableHeap.GetTable<AssemblyTable>(Table.Assembly).AddRow(new Row<AssemblyHashAlgorithm, ushort, ushort, ushort, ushort, AssemblyAttributes, uint, uint, uint>(
                    ...
                    accessor.StringHeap.GetStringIndex(Namer.GetRandomName()), 0));
        ...
        //{
        //    InvalidMetadataObfuscation cion;
        //    public Phase3(InvalidMetadataObfuscation cion) { this.cion = cion; }
        //    public override Priority Priority
        //    {
        ...
        {
            InvalidMetadataObfuscation cion;
            public Phase4(InvalidMetadataObfuscation cion) { this.cion = cion; }
            public override Priority Priority
            {
                get { return Priority.PELevel; }
            }
        ...
        public string Name { get { return "Add Invalid Metadata"; } }
        public string Description { get { return "add invalid metadata into assembly to prevent disassembler/decompiler to open the assembly."; } }
        public string ID { get { return "invalid md"; } }
